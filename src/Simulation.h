...
/*!
  ...
  Simulation results are printed to screen or file with the helper functions \ref header (prints a header a the top of data columns, which represent time) and \ref print (prints, for every neuron, for every step of the simulation a 1 if the neuron is in firing state and 0 if not).

  A Simulation is made of a vector of \ref Neuron.
